...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition hover:shadow-md">
      <Link href={`/produto/${product.slug}`} className="relative block aspect-square overflow-hidden bg-white">
        <Image
      ...
      <div className="flex flex-1 flex-col gap-2 p-3.5">
        ...
        <div className="mt-auto">
          ...
          <button
            ...
            className="mt-2.5 flex w-full items-center justify-center gap-1.5 rounded-full bg-primary py-2 text-xs font-bold text-primary-foreground transition hover:bg-brand-pink-deep disabled:cursor-not-allowed disabled:bg-muted disabled:text-muted-foreground"
          >
